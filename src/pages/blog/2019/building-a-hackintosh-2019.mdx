...
> This is part one in an ongoing series where I document my experiences building my first Hackintosh. [Read part two, where I document my process getting from first boot to first load of installed OSX, here.](/blog/2019/hackintosh-ii-install-complete/)
