...
**Update:** Lucee _does_ support for-in loops on arrays. I'm not sure why that particular loop I ran into seemed to be troublesome, but it certainly was at the time. Probably. I think.
...
<TwitterTweetEmbed tweetId={`1171405720987811841`} options={{hideThread: true}} />
