...
It's not important at this point but it provides context for what comes next: We host that monolithic app on an AWS EC2 instance, and since we're on AWS, the database is running on RDS.
