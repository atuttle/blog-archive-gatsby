...
I guess it's not a direct parallel, but this tweet* really struck a chord with me, in more areas than just the Friday-deployments problem space mentioned. Friction causes things to stop.

I converted my old dynamically rendered blog from a CFML platform to a static site generator because I wanted a place where I could play with something new and interesting, and because static site generators were all the rage. I figured if it was as simple as compiling and pushing to GitHub, that would be pretty low-friction, and I would be able to write more often.
