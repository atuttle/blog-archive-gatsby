...
![Configure the website as you normally would](./iis-node-website.png)
...
![Create a new server farm](./iis-node-create-server-farm.png)
...
![Server farm settings](./iis-node-farm-settings.png)
...
![Server farm tiles](./iis-node-farm-tiles.png)
...
![Rewrite settings](./iis-node-rewrite-config.png)
