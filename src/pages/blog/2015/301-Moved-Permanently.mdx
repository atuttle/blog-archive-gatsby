...
For the time being, my email address will stay the same, for those of you that might have it and be wondering what to do about that. I've been using it for [8+ years](http://fusiongrokker.com/page/archives), which means I've accumulated a _crap-ton_ of associated website accounts. I couldn't stop using it any time soon, even if I wanted to.
