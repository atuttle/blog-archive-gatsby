...
const FreelancePage = () => (
	<Layout>
		...
		<p>
			...
			for them. This type of job is one that I am happy to consider. You should
			also know that there is a community of people who are usually very willing
			to help out with small problems (for free!) in the <strong>#taffy</strong>{' '}
			channel on the <a href="https://cfml-slack.herokuapp.com/">CFML Slack</a>.
			Sometimes I do, too.
		</p>
		<p>
		...
		<p>
			...
			weekends schedule, with availability in the 5-20 hours per week range
			depending on what else is going on (very seasonal).
		</p>
		<p>
		...
		<p>
			...
			know: My rate is a minimum of USD $200 per hour. I am also willing to
			consider fixed-price projects if they're interesting and/or lucrative
			enough.
		</p>
		<p>
